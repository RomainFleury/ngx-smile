(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-smile', ['exports', '@angular/common', '@angular/forms', '@angular/core'], factory) :
    (factory((global['ngx-smile'] = {}),global.ng.common,global.ng.forms,global.ng.core));
    ...
    ***************************************************************************** */
    ...
    var NgxSmileComponent = /** @class */ (function () {
        function NgxSmileComponent() {
             ...
             * @param {?} repeatCount
             * @return {?}
             */function (animationDuration, defaultWidth, keyTimeBlinkStart, keyTimesPrct, repeatCount) {
                return ({
                    attributeName: 'ry',
                    fill: 'remove',
             ...
             * @param {?} repeatCount
             * @return {?}
             */function (animationDuration, defaultWidth, keyTimesPrct, repeatCount) {
                return ({
                    attributeName: 'rx',
                    fill: 'remove',
                    dur: animationDuration + "ms",
        ...
        NgxSmileComponent.propDecorators = {
            ...
            showDebug: [{ type: i0.Input }],
            size: [{ type: i0.Input }],
            faceColor: [{ type: i0.Input }],
            borderColor: [{ type: i0.Input }],
            thickness: [{ type: i0.Input }],
            mouthVariation: [{ type: i0.Input }],
            blinkRepeatSpeed: [{ type: i0.Input }]
        };
    ...
    exports.NgxSmileService = NgxSmileService;
    exports.NgxSmileComponent = NgxSmileComponent;
    exports.NgxSmileModule = NgxSmileModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ngx-smile.umd.js.map