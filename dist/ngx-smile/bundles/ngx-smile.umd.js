(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-smile', ['exports', '@angular/core', '@angular/common', '@angular/forms'], factory) :
    (global = global || self, factory(global['ngx-smile'] = {}, global.ng.core, global.ng.common, global.ng.forms));
    ...
    ***************************************************************************** */
    ...
    var NgxSmileService = /** @class */ (function () {
        ...
        /** @nocollapse */ NgxSmileService.ngInjectableDef = core.defineInjectable({ factory: function NgxSmileService_Factory() { return new NgxSmileService(); }, token: NgxSmileService, providedIn: "root" });
    ...
    var NgxSmileComponent = /** @class */ (function () {
        ...
        NgxSmileComponent.propDecorators = {
            ...
            showDebug: [{ type: core.Input }],
            size: [{ type: core.Input }],
            faceColor: [{ type: core.Input }],
            borderColor: [{ type: core.Input }],
            thickness: [{ type: core.Input }],
            mouthVariation: [{ type: core.Input }],
            blinkRepeatSpeed: [{ type: core.Input }]
        };
